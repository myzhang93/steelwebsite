      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8">
          {grades.map((grade, index) => {
            const href = grade.grade === "502 Stainless Steel" ? "/products/500-series/502" :
                        grade.grade === "503 Stainless Steel" ? "/products/500-series/503" :
                        grade.grade === "504 Stainless Steel" ? "/products/500-series/504" :
                        "/products/stainless-steel-sheet#500-series-grades"

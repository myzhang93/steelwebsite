      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8">
          {grades.map((grade, index) => {
            const href = grade.grade === "410 Stainless Steel" ? "/products/400-series/410" :
                        grade.grade === "420 Stainless Steel" ? "/products/400-series/420" :
                        grade.grade === "430 Stainless Steel" ? "/products/400-series/430" :
                        grade.grade === "446 Stainless Steel" ? "/products/400-series/446" :
                        grade.grade === "409 Stainless Steel" ? "/products/400-series/409" :
                        grade.grade === "410S Stainless Steel" ? "/products/400-series/410S" :
                        "/products/stainless-steel-sheet#400-series-grades"

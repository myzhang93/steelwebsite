...
async function POST(request) {
    try {
        ...
        const name = formData.get("Field19");
        const phone = formData.get("Field12");
        const email = formData.get("Field23");
        const message = formData.get("Field21");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b09d1c24._.js.map
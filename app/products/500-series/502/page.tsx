...
export const metadata: Metadata = {
  ...
  description: "Explore 502 stainless steel products including sheets, plates, coils, pipes, tubes, and fittings. High-temperature oxidation resistance up to 980°C.",
}
...
const products = [
  {
    title: "502 Stainless Steel Sheet & Plate",
    description: "High-quality 502 stainless steel sheets and plates with outstanding oxidation resistance up to 980°C. Perfect for furnace parts, heat shields, and high-temperature applications.",
    image: "/500/502sheet2.jpg",
    href: "/products/stainless-steel-sheet/502",
    features: [
  ...
  {
    title: "502 Stainless Steel Coil",
    description: "Premium 502 stainless steel coils with superior high-temperature properties. Ideal for furnace linings, heat exchangers, and thermal processing applications.",
    image: "/500/502coil1.jpg",
    href: "/products/stainless-steel-coil/502",
    features: [
  ...
  {
    title: "502 Stainless Steel Pipe & Tube",
    description: "Durable 502 stainless steel pipes and tubes designed for high-temperature applications. Excellent for furnace components, heat exchangers, and petrochemical processing.",
    image: "/500/502pipe1.jpg",
    href: "/products/stainless-steel-pipe-tube/502",
    features: [
  ...
  {
    title: "502 Stainless Steel Fittings",
    description: "Precision-manufactured 502 stainless steel fittings with exceptional high-temperature resistance. Perfect for high-temperature piping systems and furnace applications.",
    image: "/500/502fittings1.jpg",
    href: "/products/stainless-steel-fittings/502",
    features: [
...
export default function StainlessSteel502OverviewPage() {
  return (
    <>
      <Header />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              502 stainless steel is a ferritic alloy known for its outstanding high-temperature oxidation resistance and thermal fatigue resistance. 
              With a maximum continuous service temperature of up to 980°C, it is a cost-effective alternative to austenitic stainless steels like 310 and 309.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto mt-16">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-center border border-gray-100 hover:border-blue-200 group">
              ...
              <p className="text-gray-600 leading-relaxed">Up to 980°C continuous</p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-center border border-gray-100 hover:border-blue-200 group">
              <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-center border border-gray-100 hover:border-blue-200 group">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Thermal Fatigue Resistance</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <ul className="space-y-2 text-gray-600">
                <li className="flex justify-between">
                  <span>Chromium:</span>
                  <span className="font-semibold">4.0-6.0%</span>
                </li>
                <li className="flex justify-between">
                  <span>Carbon:</span>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <ul className="space-y-2 text-gray-600">
                <li className="flex justify-between">
                  ...
                  <span className="font-semibold">485-620 MPa</span>
                </li>
                <li className="flex justify-between">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <ul className="space-y-2 text-gray-600">
                ...
                <li className="flex justify-between">
                  ...
                  <span className="font-semibold">980°C</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-blue-50 to-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Outstanding Oxidation Resistance</h3>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Non-Hardenable</h3>
              <p className="text-gray-600 leading-relaxed">
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Explore our comprehensive range of 502 stainless steel products. Each form is designed 
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <article className="prose prose-lg max-w-none">
            <MarkdownContent content={(() => { try { return getMarkdownByPath('app/500/502stainless steel.md')?.content || '' } catch { return '' } })()} />
          </article>
        </div>
      </section>

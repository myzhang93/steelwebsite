...
export const metadata: Metadata = {
  ...
  description: "Explore 504 stainless steel products including sheets, plates, coils, pipes, tubes, and fittings. High-temperature oxidation resistance up to 1000°C.",
}
...
const products = [
  {
    title: "504 Stainless Steel Sheet & Plate",
    description: "High-quality 504 stainless steel sheets and plates with exceptional oxidation resistance up to 1000°C. Perfect for furnace linings, heat shields, and high-temperature applications.",
    image: "/500/504sheet1.jpg",
  ...
  {
    title: "504 Stainless Steel Coil",
    description: "Premium 504 stainless steel coils with superior high-temperature properties. Ideal for furnace linings, heat exchangers, and thermal processing applications.",
    image: "/500/504coil2.jpg",
    href: "/products/stainless-steel-coil/504",
    features: [
  ...
  {
    title: "504 Stainless Steel Pipe & Tube",
    description: "Durable 504 stainless steel pipes and tubes designed for high-temperature applications. Excellent for furnace components, heat exchangers, and petrochemical processing.",
    image: "/500/504pipe1.jpg",
    href: "/products/stainless-steel-pipe-tube/504",
    features: [
  ...
  {
    title: "504 Stainless Steel Fittings",
    description: "Precision-manufactured 504 stainless steel fittings with exceptional high-temperature resistance. Perfect for high-temperature piping systems and furnace applications.",
    image: "/500/504fittings1.webp",
    href: "/products/stainless-steel-fittings/504",
    features: [
...
export default function StainlessSteel504OverviewPage() {
  return (
    <>
      <Header />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              504 stainless steel is a ferritic stainless steel designed for high-performance applications requiring exceptional oxidation resistance and thermal stability. 
              Capable of withstanding temperatures up to 1000°C, it offers outstanding resistance to scaling and is a cost-effective alternative to austenitic alloys.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Thermal Stability</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Resistance to Thermal Shock</h3>
              <p className="text-gray-600 leading-relaxed">
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Explore our comprehensive range of 504 stainless steel products. Each form is designed 
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <article className="prose prose-lg max-w-none">
            <MarkdownContent content={(() => { try { return getMarkdownByPath('app/500/504-stainless steel .md')?.content || '' } catch { return '' } })()} />
          </article>
        </div>
      </section>

...
export const metadata: Metadata = {
  title: "420 Stainless Steel | High Hardness Martensitic Grade - All Product Forms",
  description: "Explore 420 stainless steel products including sheets, plates, coils, pipes, tubes, and fittings. High hardness and excellent wear resistance for knives, surgical instruments, and cutting tools.",
}
...
const products = [
  {
    title: "420 Stainless Steel Sheet & Plate",
    description: "High-quality 420 stainless steel sheets and plates with high hardness and excellent wear resistance. Perfect for knives, surgical instruments, and cutting tools requiring sharp edge retention.",
    image: "/400/420/420sheet1.jpg",
    href: "/products/stainless-steel-sheet/420",
    features: [
      "High hardness",
  ...
  {
    title: "420 Stainless Steel Coil",
    description: "Premium 420 stainless steel coils with high hardness. Ideal for high-volume precision machining operations and cutting tool manufacturing.",
    image: "/400/420/420coil1.jpg",
    href: "/products/stainless-steel-coil/420",
    features: [
  ...
  {
    title: "420 Stainless Steel Pipe & Tube",
    description: "Durable 420 stainless steel pipes and tubes designed for specialized applications. Excellent for components requiring high hardness and wear resistance.",
    image: "/400/420/420pipe1.jpg",
    href: "/products/stainless-steel-pipe-tube/420",
    features: [
  ...
  {
    title: "420 Stainless Steel Fittings",
    description: "Precision-manufactured 420 stainless steel fittings with high hardness. Perfect for specialized applications requiring wear resistance.",
    image: "/400/420/420fittings1.jpg",
    href: "/products/stainless-steel-fittings/420",
    features: [
...
export default function StainlessSteel420OverviewPage() {
  return (
    <>
      <Header />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              420 stainless steel is another martensitic stainless steel, known for its high hardness and excellent wear resistance. 
              It is often used in applications that require a sharp edge or high hardness, such as knives, surgical instruments, and other cutting tools.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto mt-16">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-center border border-gray-100 hover:border-blue-200 group">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">High Hardness</h3>
              <p className="text-gray-600 leading-relaxed">Ideal for cutting tools</p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-center border border-gray-100 hover:border-blue-200 group">
              <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-center border border-gray-100 hover:border-blue-200 group">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Sharp Edge Retention</h3>
              <p className="text-gray-600 leading-relaxed">Perfect for blades</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <ul className="space-y-2 text-gray-600">
                ...
                <li className="flex justify-between">
                  <span>Carbon:</span>
                  <span className="font-semibold">0.15-0.40%</span>
                </li>
                <li className="flex justify-between">
                  <span>Manganese:</span>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <ul className="space-y-2 text-gray-600">
                <li className="flex justify-between">
                  ...
                  <span className="font-semibold">≥655 MPa</span>
                </li>
                <li className="flex justify-between">
                  <span>Yield Strength:</span>
                  <span className="font-semibold">≥345 MPa</span>
                </li>
                <li className="flex justify-between">
                ...
                <li className="flex justify-between">
                  <span>Hardness:</span>
                  <span className="font-semibold">HRC 50-56</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <ul className="space-y-2 text-gray-600">
                ...
                <li className="flex justify-between">
                  ...
                  <span className="font-semibold">1450-1510°C</span>
                </li>
                <li className="flex justify-between">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-blue-50 to-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Maximum Hardness</h3>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Sharp Edge Retention</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Surgical Grade Quality</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Heat Treatable</h3>
              <p className="text-gray-600 leading-relaxed">
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Explore our comprehensive range of 420 stainless steel products. Each form is designed 
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <article className="prose prose-lg max-w-none">
            <MarkdownContent content={(() => { try { return getMarkdownByPath('app/400/420stainless steel.md')?.content || '' } catch { return '' } })()} />
          </article>
        </div>
      </section>

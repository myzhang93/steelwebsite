...
export default function StainlessSteel304PipeTubePage() {
  const { frontMatter: pipeFrontMatter, content: pipeContent } = getMarkdownByPath('app/300/304-stainless-steel-pipe.md')
  const { frontMatter: tubeFrontMatter, content: tubeContent } = getMarkdownByPath('app/300/304-stainless-steel-tube.md')

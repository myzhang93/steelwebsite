...
export default function StainlessSteel321TubePage() {
  const { frontMatter, content } = getMarkdownByPath('app/300/321-stainless-steel-tube.md')
        ...
        <div className="sticky top-0 z-40 bg-white border-b border-gray-200 shadow-sm">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex gap-4 py-3">
              ...
              <Link
                href="/products/stainless-steel-pipe-tube/321/tube"

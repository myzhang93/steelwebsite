...
export default function StainlessSteel303PipeTubePage() {
  const { frontMatter: pipeFrontMatter, content: pipeContent } = getMarkdownByPath('app/300/303-stainless-steel-pipe.md')
  const { frontMatter: tubeFrontMatter, content: tubeContent } = getMarkdownByPath('app/300/303-stainless-steel-tube.md')

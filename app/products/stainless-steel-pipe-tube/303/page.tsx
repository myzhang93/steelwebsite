...
export default function StainlessSteel303PipePage() {
  const { frontMatter, content } = getMarkdownByPath('app/300/303-stainless-steel-pipe.md')
        ...
        <div className="sticky top-0 z-40 bg-white border-b border-gray-200 shadow-sm">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex gap-4 py-3">
              ...
              <Link
                href="/products/stainless-steel-pipe-tube/303/tube"

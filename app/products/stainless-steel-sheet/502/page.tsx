...
export default function StainlessSteel502SheetPage() {
  const { frontMatter: sheetFrontMatter, content: sheetContent } = getMarkdownByPath('app/500/502-stainless-steel-sheet.md')
  const { frontMatter: plateFrontMatter, content: plateContent } = getMarkdownByPath('app/500/502-stainless-steel-plate.md')

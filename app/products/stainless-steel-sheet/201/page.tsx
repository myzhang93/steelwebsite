...
export default function StainlessSteel201Page() {
  const { frontMatter: sheetFrontMatter, content: sheetContent } = getMarkdownByPath('app/200/201-stainless-steel-sheet.md')
  const { frontMatter: plateFrontMatter, content: plateContent } = getMarkdownByPath('app/200/201-stainless-steel-plate.md')

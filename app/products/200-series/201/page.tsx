...
export const metadata: Metadata = {
  title: "201 Stainless Steel | Cost-Effective Austenitic Grade - All Product Forms",
  description: "Explore 201 stainless steel products including sheets, plates, coils, pipes, tubes, and fittings. Cost-effective alternative to 304 with excellent formability and good corrosion resistance.",
}
...
const products = [
  {
    title: "201 Stainless Steel Sheet & Plate",
    description: "High-quality 201 stainless steel sheets and plates offering excellent formability and good corrosion resistance. Perfect for decorative applications, cookware, and architectural uses.",
    image: "/200/201sheet.avif",
  ...
  {
    title: "201 Stainless Steel Coil",
    description: "Premium 201 stainless steel coils available in various widths and gauges. Ideal for manufacturing processes requiring continuous material supply for high-volume production.",
    image: "/200/201-stainless-steel-coil-1.webp",
    href: "/products/stainless-steel-coil/201",
    features: [
  ...
  {
    title: "201 Stainless Steel Pipe & Tube",
    description: "Durable 201 stainless steel pipes and tubes designed for various industrial and commercial applications. Excellent for plumbing, structural, and decorative purposes.",
    image: "/200/201pipe.webp",
    href: "/products/stainless-steel-pipe-tube/201",
    features: [
  ...
  {
    title: "201 Stainless Steel Fittings",
    description: "Precision-manufactured 201 stainless steel fittings including elbows, tees, reducers, and flanges. Perfect for connecting pipes and tubes in various configurations.",
    image: "/200/201fittings.jpg",
    href: "/products/stainless-steel-fittings/201",
    features: [
      "Precision manufacturing",
      "Multiple types available",
      "Easy installation",
      "Compatible with 201 pipes",
      "Durable construction"
    ]
  }
]

export default function StainlessSteel201OverviewPage() {
  return (
    <>
      <Header />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              201 stainless steel is a cost-effective austenitic grade that offers excellent formability 
              and good corrosion resistance. It serves as an economical alternative to 304 stainless steel 
              while maintaining many of its desirable properties.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto mt-16">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-center border border-gray-100 hover:border-blue-200 group">
              ...
              <p className="text-gray-600 leading-relaxed">Economical alternative to 304 grade</p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-center border border-gray-100 hover:border-blue-200 group">
              <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-center border border-gray-100 hover:border-blue-200 group">
              ...
              <p className="text-gray-600 leading-relaxed">Suitable for many applications</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              201 stainless steel is widely used across various industries and applications.
            </p>
          </div>
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Understanding the key technical characteristics of 201 stainless steel helps in selecting the right material for your application.
            </p>
          </div>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Why Choose 201 Stainless Steel?
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Discover the key advantages that make 201 stainless steel an excellent choice for your projects.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-blue-50 to-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                Significantly lower cost compared to 304 stainless steel while maintaining similar appearance and many performance characteristics.
              </p>
            </div>
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Explore our comprehensive range of 201 stainless steel products. Each form is designed 
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <article className="prose prose-lg max-w-none">
            <MarkdownContent content={(() => { try { return getMarkdownByPath('app/200/201stainless steel.md')?.content || '' } catch { return '' } })()} />
          </article>
        </div>
      </section>

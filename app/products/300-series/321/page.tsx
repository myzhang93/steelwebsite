...
export const metadata: Metadata = {
  title: "321 Stainless Steel | High-Temperature Austenitic Grade - All Product Forms",
  description: "Explore 321 stainless steel products including sheets, plates, coils, pipes, tubes, and fittings. Titanium-stabilized grade with excellent high-temperature oxidation resistance.",
}
...
const products = [
  {
    title: "321 Stainless Steel Sheet & Plate",
    description: "High-quality 321 stainless steel sheets and plates with titanium stabilization. Excellent for high-temperature applications requiring superior oxidation resistance.",
    image: "/300/321/321-stainless-steel-sheet36251205229.webp",
  ...
  {
    title: "321 Stainless Steel Coil",
    description: "Premium 321 stainless steel coils with enhanced high-temperature properties. Ideal for aerospace and heat exchanger applications.",
    image: "/300/321/321-stainless-steel-coils-500x500.webp",
    href: "/products/stainless-steel-coil/321",
    features: [
  ...
  {
    title: "321 Stainless Steel Pipe & Tube",
    description: "Durable 321 stainless steel pipes and tubes designed for high-temperature applications. Perfect for heat exchangers and aerospace uses.",
    image: "/300/321/321pipe.jpg",
    href: "/products/stainless-steel-pipe-tube/321",
    features: [
  ...
  {
    title: "321 Stainless Steel Fittings",
    description: "Precision-manufactured 321 stainless steel fittings with titanium stabilization. Perfect for high-temperature piping systems.",
    image: "/300/321/321-fittings.png",
    href: "/products/stainless-steel-fittings/321",
    features: [
...
export default function StainlessSteel321OverviewPage() {
  return (
    <>
      <Header />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              321 stainless steel is a titanium-stabilized austenitic grade with excellent 
              high-temperature oxidation resistance. Ideal for aerospace, heat exchangers, and 
              applications requiring superior performance at elevated temperatures.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto mt-16">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-center border border-gray-100 hover:border-blue-200 group">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">High-Temperature Resistance</h3>
              <p className="text-gray-600 leading-relaxed">Excellent oxidation resistance</p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-center border border-gray-100 hover:border-blue-200 group">
              <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                <Shield className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Titanium Stabilized</h3>
              <p className="text-gray-600 leading-relaxed">Prevents sensitization</p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-center border border-gray-100 hover:border-blue-200 group">
              <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <ul className="space-y-2 text-gray-600">
                ...
                <li className="flex justify-between">
                  <span>Titanium:</span>
                  <span className="font-semibold">≥5×C%</span>
                </li>
                <li className="flex justify-between">
                  <span>Carbon:</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Aerospace Grade</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Corrosion Resistance</h3>
              <p className="text-gray-600 leading-relaxed">
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Explore our comprehensive range of 321 stainless steel products. Each form is designed 
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <article className="prose prose-lg max-w-none">
            <MarkdownContent content={(() => { try { return getMarkdownByPath('app/300/321stainless steel.md')?.content || '' } catch { return '' } })()} />
          </article>
        </div>
      </section>

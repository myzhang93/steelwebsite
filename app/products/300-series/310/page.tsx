...
export const metadata: Metadata = {
  title: "310 Stainless Steel | High-Temperature Austenitic Grade - All Product Forms",
  description: "Explore 310 stainless steel products including sheets, plates, coils, pipes, tubes, and fittings. High-temperature grade with excellent oxidation resistance for extreme heat applications.",
}
...
const products = [
  {
    title: "310 Stainless Steel Sheet & Plate",
    description: "High-quality 310 stainless steel sheets and plates with exceptional high-temperature oxidation resistance. Perfect for furnace parts, heat exchangers, and extreme temperature applications.",
    image: "/300/310/310sheet.jpg",
  ...
  {
    title: "310 Stainless Steel Coil",
    description: "Premium 310 stainless steel coils with superior high-temperature properties. Ideal for furnace components and heat exchanger applications requiring continuous material supply.",
    image: "/300/310/310-stainless-steel-coil.jpg",
    href: "/products/stainless-steel-coil/310",
    features: [
  ...
  {
    title: "310 Stainless Steel Pipe & Tube",
    description: "Durable 310 stainless steel pipes and tubes designed for high-temperature applications. Perfect for heat exchangers, furnace parts, and extreme temperature environments.",
    image: "/300/310/stainless-steel-310-pipe-content.jpg",
    href: "/products/stainless-steel-pipe-tube/310",
    features: [
  ...
  {
    title: "310 Stainless Steel Fittings",
    description: "Precision-manufactured 310 stainless steel fittings with exceptional high-temperature resistance. Perfect for high-temperature piping systems and furnace applications.",
    image: "/300/310/310-fittings.jpg",
    href: "/products/stainless-steel-fittings/310",
    features: [
...
export default function StainlessSteel310OverviewPage() {
  return (
    <>
      <Header />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              310 stainless steel is a high-temperature alloy that can withstand extremely high temperatures, 
              making it ideal for use in high-heat environments. It is commonly used in furnace parts, 
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto mt-16">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-center border border-gray-100 hover:border-blue-200 group">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Extreme High-Temperature Resistance</h3>
              <p className="text-gray-600 leading-relaxed">Withstands temperatures up to 1150°C</p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-center border border-gray-100 hover:border-blue-200 group">
              <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                <Shield className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Excellent Oxidation Resistance</h3>
              <p className="text-gray-600 leading-relaxed">Superior protection at high temperatures</p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-center border border-gray-100 hover:border-blue-200 group">
              <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <ul className="space-y-2 text-gray-600">
                ...
                <li className="flex justify-between">
                  <span>Nickel:</span>
                  <span className="font-semibold">19-22%</span>
                </li>
                <li className="flex justify-between">
                  <span>Carbon:</span>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <ul className="space-y-2 text-gray-600">
                ...
                <li className="flex justify-between">
                  ...
                  <span className="font-semibold">14.2 W/m·K</span>
                </li>
                <li className="flex justify-between">
                  <span>Max Service Temp:</span>
                  <span className="font-semibold">1150°C</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-blue-50 to-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Extreme High-Temperature Performance</h3>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Superior Oxidation Resistance</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Industrial Grade</h3>
              <p className="text-gray-600 leading-relaxed">
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Explore our comprehensive range of 310 stainless steel products. Each form is designed 
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <article className="prose prose-lg max-w-none">
            <MarkdownContent content={(() => { try { return getMarkdownByPath('app/300/310-stainless steel.md')?.content || '' } catch { return '' } })()} />
          </article>
        </div>
      </section>
